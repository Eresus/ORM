 ...
 * Поле типа «entity»
 *
 * Транслируется в свойство, содержащее сущность указанного класса, связанную с текущим объектом.
 * Привязка осуществляется по идентификатору привязываемого объекта.
 *
 * Обязательные параметры:
 *
 * - «class» — полное имя класса объекта, привязанного к этому полю
 *
 * @package ORM
 * @since 3.00
 */
